...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # tensorboard and HTML visualization parameters
        parser.add_argument('--display_freq', type=int, default=400, help='frequency of showing training results on screen')
        parser.add_argument('--display_ncols', type=int, default=4, help='if positive, display all images in a single tensorboard web panel with certain number of images per row.')
        ...
        parser.add_argument('--display_env', type=str, default='main', help='tensorboard display environment name (default is "main")')
